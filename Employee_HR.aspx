...
<body class="bg-gray-100">
    ...
    <asp:Button ID="btnAddEmployee" runat="server" Text="Add Employee" CssClass="bg-[#0052cc] text-white font-semibold rounded-lg py-3 px-6 flex items-center space-x-2"/> <%--OnClick="btnAddEmployee_Click"--%> 
      ...
      >
        ...
        <div class="space-y-4">
          <div>
            ...
            <asp:TextBox ID="txtFullName" runat="server" Text="Budiono Siregar" CssClass="w-full rounded-md border border-gray-300 px-3 py-2 text-xs"></asp:TextBox>
          </div>
          <div>
            ...
            <asp:TextBox ID="txtEmail" runat="server" Text="budionosiregar27@gmail.com" CssClass="w-full rounded-md border border-gray-300 px-3 py-2 text-xs" TextMode="Email"></asp:TextBox>
          </div>
          <div>
            ...
            <asp:TextBox ID="txtPhone" runat="server" Text="084562674822" CssClass="w-full rounded-md border border-gray-300 px-3 py-2 text-xs"></asp:TextBox>
          </div>
          <div>
            ...
            <asp:TextBox ID="txtPlaceOfBirth" runat="server" Text="Medan, Sumatera Selatan" CssClass="w-full rounded-md border border-gray-300 px-3 py-2 text-xs"></asp:TextBox>
          </div>
          <div>
            ...
            <asp:TextBox ID="txtDateOfBirth" runat="server" Text="29 April 1979" CssClass="w-full rounded-md border border-gray-300 px-3 py-2 text-xs"></asp:TextBox>
          </div>
          <div>
            ...
            <asp:TextBox ID="txtAddress" runat="server" TextMode="MultiLine" Rows="4" CssClass="w-full rounded-md border border-gray-300 px-3 py-2 text-xs resize-none">Cluster The Leaf Blok F no. 12, Citra Raya, Cikupa, Kab. Tangerang, Banten</asp:TextBox>
          </div>
        </div>
        ...
        <div class="space-y-4">
          <div>
            ...
            <asp:TextBox ID="txtReligion" runat="server" Text="Buddha" CssClass="w-full rounded-md border border-gray-300 px-3 py-2 text-xs"></asp:TextBox>
          </div>
          <div>
            ...
            <asp:TextBox ID="txtNationalID" runat="server" Text="3603032904790001" CssClass="w-full rounded-md border border-gray-300 px-3 py-2 text-xs"></asp:TextBox>
          </div>
          <div>
            ...
            <div class="flex items-center space-x-4 text-xs">
              <asp:RadioButton ID="rbMale" runat="server" GroupName="Gender" Text="Male" CssClass="accent-[#1d8ed1]" Checked="True" />
              <asp:RadioButton ID="rbFemale" runat="server" GroupName="Gender" Text="Female" CssClass="accent-gray-400" />
            </div>
          </div>
          <div>
            ...
            <div class="flex items-center space-x-4 text-xs">
              <asp:RadioButton ID="rbMarried" runat="server" GroupName="MarriageStatus" Text="Married" CssClass="accent-[#1d8ed1]" Checked="True" />
              <asp:RadioButton ID="rbSingle" runat="server" GroupName="MarriageStatus" Text="Single" CssClass="accent-gray-400" />
            </div>
          </div>
          <div>
            <asp:Label ID="lblBloodType" runat="server" Text="Blood Type" CssClass="block text-[10px] font-semibold text-black mb-1"></asp:Label>
            <div class="flex items-center space-x-4 text-xs">
              <asp:RadioButton ID="rbBloodA" runat="server" GroupName="BloodType" Text="A" CssClass="accent-gray-400" />
              <asp:RadioButton ID="rbBloodAB" runat="server" GroupName="BloodType" Text="AB" CssClass="accent-gray-400" />
              <asp:RadioButton ID="rbBloodB" runat="server" GroupName="BloodType" Text="B" CssClass="accent-[#1d8ed1]" Checked="True" />
              <asp:RadioButton ID="rbBloodO" runat="server" GroupName="BloodType" Text="O" CssClass="accent-gray-400" />
            </div>
          </div>
        </div>
        ...
        <div class="space-y-4">
          <div>
            ...
            <asp:TextBox ID="txtNIP" runat="server" Text="65132879551" CssClass="w-full rounded-md border border-gray-300 px-3 py-2 text-xs"></asp:TextBox>
          </div>
          <div>
            ...
            <asp:TextBox ID="txtStatus" runat="server" Text="PKWTT" CssClass="w-full rounded-md border border-gray-300 px-3 py-2 text-xs"></asp:TextBox>
          </div>
          <div>
            ...
            <asp:TextBox ID="txtJoinDate" runat="server" Text="24 March 2000" CssClass="w-full rounded-md border border-gray-300 px-3 py-2 text-xs"></asp:TextBox>
          </div>
          <div>
            ...
            <asp:TextBox ID="txtBranch" runat="server" Text="-" CssClass="w-full rounded-md border border-gray-300 px-3 py-2 text-xs"></asp:TextBox>
          </div>
          <div>
