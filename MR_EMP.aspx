...
<div class="flex flex-col md:flex-row gap-6">
     ...
     <section class="flex-1 w-1/2">
      ...
      <div>
       <asp:Label AssociatedControlID="ddlDiseaseCategory" runat="server" Text="Disease Category" CssClass="block text-xs font-semibold mb-1" />
       <asp:DropDownList ID="ddlDiseaseCategory" runat="server" CssClass="w-full rounded-md bg-gray-200 text-gray-900 py-2 px-3">
        <asp:ListItem>Penyakit Dalam</asp:ListItem>
       </asp:DropDownList>
      </div>
      <div>
       ...
       <asp:TextBox ID="txtMedicalDetail" runat="server" TextMode="MultiLine" Rows="4" CssClass="w-full rounded-md bg-gray-200 text-xs p-3 resize-none">Diagnosa: Gerd pada lambung</asp:TextBox>
      </div>
      <div>
